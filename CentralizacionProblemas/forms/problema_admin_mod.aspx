<%@ Page Title="Nuevo Seguimiento - Gestion de Mejoras" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="problema_admin_mod.aspx.cs" Inherits="CentralizacionProblemas.problema_admin_mod" 
        ...
        <asp:UpdatePanel ID="updListaProblema" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gvListaProblema" runat="server" AllowPaging="true" 
                    ...
                    PagerSettings-PageButtonCount="5" PagerSettings-Mode="NumericFirstLast" 
            ...
            <ContentTemplate>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFechaComp" runat="server" placeholder="Ingrese Fecha"></asp:TextBox>
                ...
                <asp:Button ID="btnAgregar" runat="server" Text="Agregar Seguimiento" 
                    onclick="btnAgregar_Click" /><%--OnClientClick="return antesIngresar();"--%>
            </ContentTemplate>
        </asp:UpdatePanel>
    </asp:Panel>    
        ...
        <asp:UpdatePanel ID="updTodoSegto" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="gvTodoSegto" runat="server" AllowPaging="true" 
                    AutoGenerateColumns="false" PageSize="5" PagerSettings-PageButtonCount="5" PagerSettings-Mode="NumericFirstLast" 
                    PagerSettings-FirstPageText="Primera" PagerSettings-LastPageText="Ultima" 
