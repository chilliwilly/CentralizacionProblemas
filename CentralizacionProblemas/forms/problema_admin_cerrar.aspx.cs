...
{
    public partial class problema_admin_cerrar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //txtResponsable.Text = Session["nom_logeado"].ToString();                
            }
        }
        ...
        private void cleanCerrarSeguimiento()
        {
            objProblemaBal = new problem_bal();
            cddEstado.SelectedValue = "3";
